        ...
        <div class="row">
            <div class="col-md-12 form-group">
                ...
                <input id="pfname" type="text" class="form-control"
                       name="pfname" value="<?php if (isset($profile)) echo $profile['profile_name']?>" placeholder="..." required>
            </div>

            <div class="col-md-6">
                <label for="pfimg">Profile Image</label>
                <input id="pfimg" type="text" class="form-control"
                       name="pfimg" value="<?php if (isset($profile)) echo $profile['profile_img']?>" placeholder="Insert URL...">
            </div>
            <div class="row">
