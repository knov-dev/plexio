...
if ($_POST['id'] == '') {
    $query = "INSERT into movies (name,rel_date,duration,description,media_url,cover_img,reg_date) 
VALUES ('$movie_name', '" . ($movie_date) . "','$movie_length','$movie_desc','$movie_url','$movie_cover','$mysqltime')";
} else {
